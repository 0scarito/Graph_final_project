"""
Script to generate graph_eda.ipynb Jupyter notebook.
Run this script to create the notebook file.
"""
...
with open("graph_eda.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2, ensure_ascii=False)

print("✓ Successfully created graph_eda.ipynb")
